 ...
 */
final class Version20220517153503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP doc_file_name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD doc_file_name VARCHAR(255) NOT NULL');
    }
}
